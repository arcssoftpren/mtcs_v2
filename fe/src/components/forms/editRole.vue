...
const props = defineProps(['closeMe', 'role']);
const store = useAppStore();
const formData = reactive({
  roleId: props.role ? props.role.roleId : '',
  roleName: props.role ? props.role.roleName : '',
  accessRights: props.role ? JSON.parse(props.role.accessRights) : [],
  homePage: props.role ? props.role.homePage : '',
});
const structure = {
  roleName: {
    label: 'Role Name',
